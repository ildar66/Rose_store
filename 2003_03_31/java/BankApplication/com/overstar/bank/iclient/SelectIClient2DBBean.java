...
*
* Description - SelectIClient2DBBean
*/ 
...
public class SelectIClient2DBBean extends java.lang.Object 
{
  ...
  */
  protected java.lang.String SQLString = "SELECT    QRSDTTST.PARTY.NAME AS NAME,    QRSDTTST.CLIENT.PARTYID AS PARTYID FROM    QRSDTTST.CLIENT,    QRSDTTST.PARTY WHERE    (       (         QRSDTTST.PARTY.PARTYID = QRSDTTST.CLIENT.PARTYID       )      AND     (( QRSDTTST.CLIENT.SERVICEKIND = 1001 ))    ) ORDER BY    NAME";
  ...
  */
  public void execute()  
   throws com.ibm.db.DataException, java.io.IOException, java.lang.Exception, NoDataException
  {  
  ...
  */
...

  {
	...
	connection = getPooledConnection(getDriver(), getURL(), getUserID(), password);
	...
	metaData.addTable("QRSDTTST.PARTY");
	metaData.addTable("QRSDTTST.CLIENT");
  ...
  protected Connection getPooledConnection(String driver, String URL, String userID, String password)
  {
	...
	catch (Throwable t)
	{
	  ...
	  try
	  {
		...
		if (attrs.name.startsWith(com.ibm.websphere.advanced.cm.factory.DataSourceFactory.DEFAULT_DATASOURCE_CONTEXT_NAME + "/"))
		{
		  attrs.name = attrs.name.substring(com.ibm.websphere.advanced.cm.factory.DataSourceFactory.DEFAULT_DATASOURCE_CONTEXT_NAME.length() + 1);
		}
