...
import com.overstar.bank.iclient.SelectIClientDBBean;


public class SelectIClient extends com.ibm.webtools.runtime.StudioPervasiveServlet implements Serializable
  ...
  */
  public void performTask(HttpServletRequest request, HttpServletResponse response)
  {
	...
	try 
	{
	  ...
	  com.overstar.bank.iclient.SelectIClientDBBean iclientDBBean = new com.overstar.bank.iclient.SelectIClientDBBean();      
	  session.putValue("iclientDBBean", iclientDBBean);


	  // Initialize the bean userID property from the parameters
	  iclientDBBean.setUserID(getParameter(request, "userID", true, true, false, null));

	  // Initialize the bean password optional property from the parameters
	  iclientDBBean.setPassword(getParameter(request, "password", true, true, false, null));
	  
	  // Initialize the bean URL property from the parameters
	  iclientDBBean.setURL(getParameter(request, "URL", true, true, false, null));

	  // Initialize the bean driver property from the parameters
	  iclientDBBean.setDriver(getParameter(request, "driver", true, true, false, null));
	  
	  // Initialize the bean dataSourceName optional property
	  iclientDBBean.setDataSourceName(getParameter(request, "dataSourceName", true, true, false, null));
	  
	  
	  // Call the execute action on the bean.
	  iclientDBBean.execute();
