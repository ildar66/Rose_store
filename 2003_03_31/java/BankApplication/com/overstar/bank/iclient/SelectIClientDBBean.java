...
*
* Description - SelectIClientDBBean
*/ 
...
public class SelectIClientDBBean extends java.lang.Object 
{
  ...
  */
  protected java.lang.String SQLString = "SELECT    QRSDTTST.PARTY.NAME AS NAME FROM    QRSDTTST.CLIENT,    QRSDTTST.PARTY WHERE    (       (         QRSDTTST.PARTY.PARTYID = QRSDTTST.CLIENT.PARTYID       )      AND     (( QRSDTTST.CLIENT.SERVICEKIND = 1001 ))    ) ORDER BY    NAME";
