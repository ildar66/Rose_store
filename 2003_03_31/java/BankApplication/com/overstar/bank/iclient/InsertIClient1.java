...
import com.overstar.bank.iclient.InsertIClient1DBBean;


public class InsertIClient1 extends com.ibm.webtools.runtime.StudioPervasiveServlet implements Serializable
  ...
  */
  public void performTask(HttpServletRequest request, HttpServletResponse response)
  {
	...
	try 
	{
	  ...
	  com.overstar.bank.iclient.InsertIClient1DBBean inserIClient1DBBean = new com.overstar.bank.iclient.InsertIClient1DBBean();      
	  session.putValue("inserIClient1DBBean", inserIClient1DBBean);


	  // Initialize the bean userID property from the parameters
	  inserIClient1DBBean.setUserID(getParameter(request, "userID", true, true, false, null));

	  // Initialize the bean password optional property from the parameters
	  inserIClient1DBBean.setPassword(getParameter(request, "password", true, true, false, null));
	  
	  // Initialize the bean URL property from the parameters
	  inserIClient1DBBean.setURL(getParameter(request, "URL", true, true, false, null));

	  // Initialize the bean driver property from the parameters
	  inserIClient1DBBean.setDriver(getParameter(request, "driver", true, true, false, null));
	  
	  // Initialize the bean dataSourceName optional property
	  inserIClient1DBBean.setDataSourceName(getParameter(request, "dataSourceName", true, true, false, null));
	  
	  
	  // Initialize the bean partyID property from the parameters
	  
		inserIClient1DBBean.setPartyID(getParameter(request, "partyID", true, true, true, null));
	  
	  
	  // Initialize the bean name property from the parameters
	  
		inserIClient1DBBean.setName(getParameter(request, "name", true, true, true, null));
	  
	  
	  // Initialize the bean pass property from the parameters
	  
		inserIClient1DBBean.setPass(getParameter(request, "pass", true, true, true, null));
	  
	  
	  // Call the execute action on the bean.
	  inserIClient1DBBean.execute();
