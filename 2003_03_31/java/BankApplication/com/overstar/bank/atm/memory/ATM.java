...
public ATM(ATMPK anId) 
{
	...
	atmAccount = (ATMAccount) ATMAccount.findWithBankAccountPK(
					new BankAccount.BankAccountPK(anId.getIdAsString())); // use same key for ATMAccount
...
//System.out.println("from chooseAccount1: ATM");
...
//System.out.println("from chooseAccount2: ATM");
		setCurrentBankAccount(aBankAccount);
//System.out.println("from chooseAccount3: ATM");
		setState(BANK_ACCOUNT_CHOOSEN);
//System.out.println("from chooseAccount4: ATM");
	} else {
...
throws IllegalStateException, InvalidPINException {
 ...
 * @return ATM instance
 */  
public static ATM findWithATMPK(ATMPK anId) 
{
	ATM tempATM;
...
public static ATM findWithATMPK(String anIdStr) 
{
 ...
 * NOTE: Only positive amounts can be dispensed.
 * 
 * Creation date: (11/29/00 1:43:13 AM)
 * @return com.ibm.itso.sg245264.Money
 * @param anAmount com.ibm.itso.sg245264.Money
 * @exception java.lang.IllegalStateException The ATM is not in the proper state
 * @exception java.lang.IllegalArgumentException The amount to dispense must be positive
...
throws IllegalArgumentException, IllegalStateException, TransactionAbortedException {
	if (state == ASK_AMOUNT) {
